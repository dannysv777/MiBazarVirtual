    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <SuccessModal
        ...
        onViewOrders={() => {
          ...
          navigation.navigate('Pedidos', { screen: 'Orders' });
        }}
      />
    </SafeAreaView>
  );
...
function SuccessModal({ visible, onViewOrders }) {
  return (
    <Modal visible={visible} transparent animationType="fade">
      <View style={styles.modalOverlay}>
        <View style={styles.successCard}>
          ...
          <Text style={styles.successBody}>Tu pedido ha sido enviado al vendedor</Text>
          <AppButton title="Ver mis pedidos" onPress={onViewOrders} fullWidth />
        </View>
      </View>
    </Modal>
  );
