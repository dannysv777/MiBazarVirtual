...
public record OrderResponse(
    ...
    public static OrderResponse from(Order order, List<OrderItem> items) {
        return new OrderResponse(
                ...
                order.getStore() == null ? "Mercado municipal" : order.getStore().getName(),
                ...
                order.getTotal(),
                order.getNotes(),
                order.getDeliveryWorker() == null ? null : order.getDeliveryWorker().getId(),
                order.getDeliveryWorker() == null ? null : order.getDeliveryWorker().getFullName(),
